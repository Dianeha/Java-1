...
public class ArrayApp_0418 {
	public static void main(String[] args) {
		...
		// for 명령을 이용한 배열의 일괄처리 - 첨자 이용(입력,연산,출력) //알고리즘에서 많이 사용
		...
		// for 명령을 이용한 배열의 일괄처리 - 반복지시자(Iterator) 이용(연산, 출력 처리 용도)//웹어플리케이션 등 출력위주로 많이
		// 사용
		for (int temp : su) {
		...
		// 배열 요소에 저장된 값 중 30~60 범위의 갯수를 계산하여 출력하세요.
		int cnt = 0;
		...
		*/
		...
		System.out.println("30~60 범위의 갯수 = " + cnt);
	}
}
